...
for filename in os.listdir(directory):
    if filename.endswith(".yuv"):
        ...
        command = [
            ...
            "-b", os.path.join(directory, f"{input_filename}_42.bin"),
            "-o", os.path.join(directory, f"{input_filename}_42_recon.yuv"),
            ">", os.path.join(directory, f"{input_filename}_42.log"),
            "2>&1"
        ]
